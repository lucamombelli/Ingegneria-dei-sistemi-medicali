...
ascissa di convergenza assoluta lla Trasformata di Laplace di f 9
	% Tabella delle proprietà della trasformata di Laplace
	% Colonna per le dimostrazioni lasciata vuota
% Tabella delle proprietà della trasformata di Laplace con considerazioni sulla ROC
\begin{table}[h!]
	\centering
